...
# mffs helper: write FPSCR with mtfsf, move it to f2 via mffs, and expose CR1 via Rc/mfcr.
TESTS[fp_mffs_helper]="3C600000 90610100 38600003 90610104 CBE10100 FDFEFD8E FC40048F D8410108 80A10108 80C1010C 7CE00026"
TEST_ORDER+=(fp_mffs_helper)
...
# Dotted VXR form must update CR6. Current JIT delegates dotted forms because Rc is in the low XO key.
TESTS[vec_vcmpequw_dot_cr6]="10050718 10250718 10400C86 7CA00026"
...
# AltiVec FP edge semantics: signed zero and NaN propagation must match interpreter.
# These are coverage vectors first; if any diverges, delegate the affected native FP family.
TESTS[vec_vmaxfp_signed_zero]="38600000 90610600 90610604 90610608 9061060C 3C808000 90810610 90810614 90810618 9081061C 38600600 7C0118CE 38600610 7C2118CE 10400C0A 38600620 7C4119CE 80A10620 80C10624"
TEST_ORDER+=(vec_vmaxfp_signed_zero)
TESTS[vec_vminfp_signed_zero]="38600000 90610600 90610604 90610608 9061060C 3C808000 90810610 90810614 90810618 9081061C 38600600 7C0118CE 38600610 7C2118CE 10400C4A 38600620 7C4119CE 80A10620 80C10624"
TEST_ORDER+=(vec_vminfp_signed_zero)
TESTS[vec_vmaxfp_nan]="3C807FC0 60840001 90810600 90810604 90810608 9081060C 3C803F80 90810610 90810614 90810618 9081061C 38600600 7C0118CE 38600610 7C2118CE 10400C0A 38600620 7C4119CE 80A10620 80C10624"
TEST_ORDER+=(vec_vmaxfp_nan)
TESTS[vec_vaddfp_nan]="3C807FC0 60840001 90810600 90810604 90810608 9081060C 3C803F80 90810610 90810614 90810618 9081061C 38600600 7C0118CE 38600610 7C2118CE 1040080A 38600620 7C4119CE 80A10620 80C10624"
TEST_ORDER+=(vec_vaddfp_nan)
TESTS[vec_vmaddfp_signed_zero]="3C808000 90810600 90810604 90810608 9081060C 3C803F80 90810610 90810614 90810618 9081061C 3C808000 90810620 90810624 90810628 9081062C 38600600 7C0118CE 38600610 7C2118CE 38600620 7C4118CE 1040106E 38600630 7C4119CE 80A10630 80C10634"
TEST_ORDER+=(vec_vmaddfp_signed_zero)
...
TESTS[vec_vmrghb_delegated]="38800101 64840101 90810600 90810604 90810608 9081060C 38800202 64840202 90810610 90810614 90810618 9081061C 38600600 7C0118CE 38600610 7C2118CE 1040080C 38600620 7C4119CE 80A10620 80C10624"
TEST_ORDER+=(vec_vmrghb_delegated)
TESTS[vec_vmrglw_delegated]="3C801111 60841111 90810600 3C802222 60842222 90810604 3C803333 60843333 90810608 3C804444 60844444 9081060C 3C805555 60845555 90810610 3C806666 60846666 90810614 3C807777 60847777 90810618 3C808888 60848888 9081061C 38600600 7C0118CE 38600610 7C2118CE 1040098C 38600620 7C4119CE 80A10620 80C10624"
TEST_ORDER+=(vec_vmrglw_delegated)

# AltiVec multiply even/odd family is delegated: old native encodings were narrow MUL/SMLSL,
...
# vsrab: arithmetic right shifts are delegated until signedness/count semantics are proven.
TESTS[vec_vsrab_delegated]="38808080 64848080 90810600 90810604 90810608 9081060C 38800101 64840101 90810610 90810614 90810618 9081061C 38600600 7C0118CE 38600610 7C2118CE 10400B04 38600620 7C4119CE 80A10620 80C10624"
TEST_ORDER+=(vec_vsrab_delegated)
# vsrb: 0x80 >> 1 logical -> 0x40; old native SSHL-like path sign/round shifted.
TESTS[vec_vsrb_delegated]="38808080 64848080 90810600 90810604 90810608 9081060C 38800101 64840101 90810610 90810614 90810618 9081061C 38600600 7C0118CE 38600610 7C2118CE 10400A04 38600620 7C4119CE 80A10620 80C10624"
TEST_ORDER+=(vec_vsrb_delegated)

# AltiVec saturating pack/narrow family is delegated until exact signedness/lane order and VSCR.SAT exist.
TESTS[vec_vpkshus_delegated]="38807FFF 64847FFF 90810600 90810604 90810608 9081060C 38800001 64840001 90810610 90810614 90810618 9081061C 38600600 7C0118CE 38600610 7C2118CE 1040090E 38600620 7C4119CE 80A10620 80C10624"
TEST_ORDER+=(vec_vpkshus_delegated)
...
TESTS[vec_vupkhsb_delegated]="3880807F 648401FE 90810600 90810604 90810608 9081060C 38800203 64840405 90810610 38600600 7C0118CE 1040020E 38600620 7C4119CE 80A10620 80C10624"
TEST_ORDER+=(vec_vupkhsb_delegated)

# Non-saturating AltiVec pack family is delegated: old native path ignored vA and narrowed only vB.
TESTS[vec_vpkuhum_delegated]="3C800001 60840002 90810600 3C800003 60840004 90810604 3C800005 60840006 90810608 3C800007 60840008 9081060C 3C800009 6084000A 90810610 3C80000B 6084000C 90810614 3C80000D 6084000E 90810618 3C80000F 60840010 9081061C 38600600 7C0118CE 38600610 7C2118CE 1040080E 38600620 7C4119CE 80A10620 80C10624"
TEST_ORDER+=(vec_vpkuhum_delegated)
TESTS[vec_vpkuwum_delegated]="3C800001 60800002 90810600 3C800003 60800004 90810604 3C800005 60800006 90810608 3C800007 60800008 9081060C 3C800009 6080000A 90810610 3C80000B 6080000C 90810614 3C80000D 6080000E 90810618 3C80000F 60800010 9081061C 38600600 7C0118CE 38600610 7C2118CE 1040084E 38600620 7C4119CE 80A10620 80C10624"
TEST_ORDER+=(vec_vpkuwum_delegated)

# AltiVec pixel unpack is delegated: interpreter expands 1/5/5/5 pixel fields, native path only zero-extended halfwords.
TESTS[vec_vupklpx_delegated]="3880801F 648403E0 90810600 38807C00 6484FFFF 90810604 38600600 7C0118CE 104003CE 38600620 7C4119CE 80A10620 80C10624"
TEST_ORDER+=(vec_vupklpx_delegated)
