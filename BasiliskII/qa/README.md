...
Use the small 8MB RAM footprint only for deterministic headless ROM proof runs. Desktop/VNC and hardware-adjacent QA should use 64MB (`ramsize 67108864`) and `jitcachesize 131072`; earlier 32768KB runs showed repeated hard translation-cache flushes during ROM/headless windows.
