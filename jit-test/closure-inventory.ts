...
const auditFamilyRules: Array<[RegExp, string]> = [
  ...
  [/^jff_MV2SCCR$/, "AARCH64_JIT_AUDIT_MV2SCCR_LIFECYCLE.md"],
  [/^sub_l_ri$/, "AARCH64_JIT_AUDIT_SUB_L_RI_LIFECYCLE.md"],
...
const primitiveAuditRules: Array<[RegExp, string]> = [
  ...
  [/^raw_fflags_into_flags$/, "AARCH64_JIT_AUDIT_RAW_FFLAGS_INTO_FLAGS_BOUNDARY.md"],
...
const semanticServiceMid = new Map<string, string>([
  ...
  ["fpowx_rr", "the sole configured AArch64 FTWOTOX root enters exact MPFR exp2 service before operand acquisition or the retained host-pow MIDFUNC call; AARCH64_JIT_AUDIT_FPOWX_UNREACHABLE.md"],
...
const structuralUnreachableRaw = new Map<string, string>([
  ...
  ["raw_fpowx_rr", "only its LOWFUNC/LENDFUNC definition remains after configured AArch64 FTWOTOX enters exact MPFR exp2 service before unreachable fpowx_rr; AARCH64_JIT_AUDIT_FPOWX_UNREACHABLE.md"],
