...
const serviceCases: ServiceCase[] = [
  ...
  { name: "fdiv_source_snan_beats_destination_qnan", selector: "20", destination: x.qnanA, source: x.nsnanB, output: x.nquietB, fpsr: "09000080", operationFpsr: "09004080" },
  { name: "fdiv_destination_snan_beats_source_qnan", selector: "20", destination: x.snanA, source: x.nqnanB, output: x.quietA, fpsr: "01000080", operationFpsr: "01004080", destinationSnan: true },
