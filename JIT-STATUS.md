...
**JIT optlev=2:** ⚠️ Full-JIT default. The historical `040ba0xx` late-ROM spin is **FIXED (2026-06-22)** — see below. With the fix the all-native boot now clears the NuBus/Slot-Manager frontier and advances to the next genuine frontier `040026f8`; desktop not yet reached.
